            ...
            if (message != null && message.Text != null && message.Chat != null)
            {
                ...
                if (!shouldIgnoreMessage)
                {
                    ...
                    string[] dirtyWords =
                    {
                        ...
                        "хуйня", "хуїта", "хуїту", "хуєт",
                        "хуйло", "нах", "нахуй", "хуєсос", "хуєсоси", "підор", "підар", "підарам", "Пидарье", "Пидорье", "йобаний", "хуєфікатор", "йобана",
                        "єбана", "єбати", "ебаная", "єбать", "єбаний", "єбошить", "йбн", "заєбав", "заїбав", "доєбатись",
                        ...
                        "курвище",
                        "курвий", "курви", "yobana", "blyad", "найобуєте", "найобуєш", "найобує", "наєбав", "найобщик", "наїбав", "наїбали", "наїбалово", "наебалово",
