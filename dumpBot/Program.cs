        ...
        if (message != null)
        {
            ...
            if (message != null && message.Text != null && message.Chat != null)
            {
                ...
                if (!shouldIgnoreMessage)
                {
                    ...
                    string[] dirtyWords =
                    {
                        "блять", "блядь", "бля", "блядина", "блядіна", "ублюдок", "хуй", "хуйот", "хер", "ніхера", "ніхуя",
                        ...
                        "єбана", "єбати", "єбать", "єбаний", "єбошить", "заєбав", "заїбав",
                        "їбати", "їбаний", "єбанько", "їбанько",
                        "пизда", "пізда", "піздато", "пізди", "пизди", "піздабол", "пиздабол", "пиздець", "піздєц", "пздц", "пиздеж", "пиздежа",
                        "мудло", "мудак", "сука",
